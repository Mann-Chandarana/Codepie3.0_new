                ...
                <div className="row portfolio-container">
                    <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div className="portfolio-wrap">
                            <img
                                style={{ height: '400px' }}
                                src="assets/images/codepie_photos/1.webp"
                                className="img-fluid"
                                alt=""
                            />
                        </div>
                    ...
                    <div style={{ marginBottom: '-2rem' }} className="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div className="portfolio-wrap">
                            <img
                                style={{ height: '300px' }}
                                src="assets/images/codepie_photos/2.webp"
                                className="img-fluid"
                                alt=""
                            />
                        </div>
                    ...
                    <div className="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div className="portfolio-wrap">
                            <img
                                style={{ height: '400px' }}
                                src="assets/images/codepie_photos/3.webp"
                                className="img-fluid"
                                alt=""
                            />
                        </div>
                    ...
                    >
                        <div className="portfolio-wrap">
                            <img
                                style={{ height: '330px' }}
                                src="assets/images/codepie_photos/team.webp"
                                className="img-fluid"
                                alt=""
                            />
                        </div>
