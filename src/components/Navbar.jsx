    ...
    return (
        <header style={{backgroundColor:"#4937a6"}} id="header" className="fixed-top">
            <div className="container d-flex align-items-center justify-content-between">
                ...
                <h1 style={{marginBottom:"-5px"}} className="navbar-brand"><a style={{textDecoration:"none",color:"white"}} href="index.html"><img className='codepie-img' src="1.png" alt="" />   CODE<span style={{color:"orange"}}>PIE</span> 3.0</a></h1>
